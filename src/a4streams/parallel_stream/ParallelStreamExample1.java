package a4streams.parallel_stream;
...
public class ParallelStreamExample1 {
    ...
    public static List<String> sequentialStream(){
        ...
        System.out.println("Duration in sequential stream : "+ (duration-start));
    ...
    public static List<String> parallelStream(){
        ...
        long duration = System.currentTimeMillis();
        System.out.println("Duration in parallel stream : "+ (duration-start));
